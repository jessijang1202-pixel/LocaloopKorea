...
export const KO: LandingData = {
  ...
  hero: {
    ...
    cards: [
      ...
      { emoji:"📖", name:"서울 지하철 완전정복",      area:"교통 가이드",     tag:"필수 정보",      bg:"#EFF6FF", border:"#BFDBFE", tagColor:"#2563EB" },
  ...
  features: {
    ...
    title: "로컬을 경험하는",
    titleAccent: "4가지 방법",
    desc: "관광객이 아닌 로컬처럼 서울을 즐기는 데 필요한 모든 것",
    items: [
  ...
  footer: {
    desc:  "외국인과 한국인을 위한 서울 지역 기반 생활 네비게이션",
...
export const EN: LandingData = {
  ...
  hero: {
    badge: "🇰🇷  Seoul living guide for foreigners",
    titleLight:  "Experience",
    titleAccent: "real local",
    titleBold:   "Seoul",
    subtitle:    "Foreigner-friendly spots, food guides, life tips, meetups—\neverything that makes living in Seoul easier, in one place.",
    ctaPrimary:   "Get started free 🚀",
    ctaSecondary: "Learn more",
    proof: "expats & locals have already joined",
    cards: [
      { emoji:"☕", name:"Fritz Coffee Company",      area:"Seongsu, Seoul",   tag:"English menu",     bg:"#FFF7ED", border:"#FED7AA", tagColor:"#EA580C" },
      { emoji:"🍜", name:"Tteokbokki 101 Guide",     area:"Food guide",        tag:"Beginner-friendly", bg:"#F0FDFA", border:"#99F6E4", tagColor:"#0D9488" },
      { emoji:"🤝", name:"Korean Language Exchange",  area:"Hongdae, Seoul",   tag:"12 going",         bg:"#F5F3FF", border:"#DDD6FE", tagColor:"#7C3AED" },
      { emoji:"🍺", name:"Craftworks Taproom",        area:"Itaewon, Seoul",   tag:"English OK",       bg:"#EFF6FF", border:"#BFDBFE", tagColor:"#2563EB" },
      { emoji:"📖", name:"Seoul Metro Survival",      area:"Transport guide",  tag:"Must read",        bg:"#EFF6FF", border:"#BFDBFE", tagColor:"#2563EB" },
      { emoji:"🍱", name:"Convenience Store Guide",   area:"Food guide",       tag:"Budget-friendly",   bg:"#F0FDFA", border:"#99F6E4", tagColor:"#0D9488" },
      { emoji:"🏪", name:"Olive Young Shopping Tips", area:"Myeongdong, Seoul",tag:"Expat favorite",    bg:"#FFF7ED", border:"#FED7AA", tagColor:"#EA580C" },
  ...
  steps: {
    label: "How it works",
    title: "Your Seoul Journey",
    desc:  "Just 4 steps to start living like a Seoul local",
    items: [
  ...
  features: {
    ...
    titleAccent: "Seoul like a local",
  ...
  areas: {
    ...
    desc: "Curated guides for every major area in Seoul",
    items: [
      { name:"Seongsu",  ko:"성수동", desc:"Seoul's Brooklyn — indie cafés, design studios, and curated shops.", emoji:"🏭", bg:"#FFF7ED", border:"#FED7AA" },
      { name:"Hongdae",  ko:"홍대",   desc:"Street food, live music, and the best late-night spots in Seoul.",   emoji:"🎵", bg:"#F0FDFA", border:"#99F6E4" },
      ...
      { name:"Bukchon",  ko:"북촌",   desc:"Traditional hanok village — the best place to feel Seoul's history.",emoji:"🏯", bg:"#FFF1F2", border:"#FECDD3" },
    ],
  },
  tips: {
    label: "Tips",
