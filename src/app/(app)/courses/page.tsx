...
const T = {
  ko: { localScore: "로컬 점수", stops: "경유지", start: "코스 시작", noResults: "해당 코스가 없어요", about: "코스 소개", route: "이동 경로", budget: "예산", time: "소요 시간" },
  en: { localScore: "Local Score", stops: "Stops", start: "Start Course", noResults: "No courses found", about: "About this course", route: "Route", budget: "Budget", time: "Duration" },
};
...
export default function CoursesPage() {
  ...
  const filterChips = (
    <div className="ll-split-panel-sticky scroll-x" style={{ padding: "10px 14px", display: "flex", gap: 8, alignItems: "center" }}>
      {filters.map((label, i) => {
      ...
      <div style={{ height: "100%", overflowY: "auto", background: "var(--content-bg)" }}>
        ...
        <div style={{ padding: "24px 32px 40px" }}>
          ...
          <div style={{ background: "var(--card)", borderRadius: 14, padding: "16px 18px", border: "1px solid var(--border)", marginBottom: 24 }}>
            ...
            {stops.map((stop, i) => (
              <div key={i}>
                <div style={{ display: "flex", alignItems: "flex-start", gap: 14, marginBottom: i < stops.length - 1 ? 0 : 0 }}>
                  ...
                  <div style={{ flex: 1, paddingBottom: i < stops.length - 1 ? 0 : 0 }}>
