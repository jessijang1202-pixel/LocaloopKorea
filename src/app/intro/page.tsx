...
const MOB_KO: MobSlide[] = [
  ...
  { icon: "💬", img: "", tag: "기능 05", lines: ["실시간 번역 채팅으로", "언어 장벽 없애기"], hi: 1, desc: "한국어를 몰라도 괜찮아요.\n메시지를 보내면 AI가 즉시 번역해\n상대방에게 전달해드려요.\n자연스러운 대화, 진짜 연결.", bg: "#08151E", ac: "#15b6c1", chatPreview: true },
];
